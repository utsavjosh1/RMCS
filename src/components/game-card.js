...
export function GameCard({ game, onJoin }) {
  ...
  return (
    <div className="h-[320px] bg-white rounded-2xl border-4 border-violet-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] hover:rotate-[0.5deg] flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col">
        <h3 className="text-xl font-bold text-purple-800 mb-2 line-clamp-1">
          {game.title}
        </h3>
        ...
        <Button
          ...
          className={cn(
            "w-full rounded-xl font-bold text-white mt-auto",
